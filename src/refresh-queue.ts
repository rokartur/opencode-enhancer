...
const REFRESH_QUEUE_CONCURRENCY_ENV = 'OPENCODE_ENHANCER_REFRESH_QUEUE_CONCURRENCY'
const LEGACY_REFRESH_QUEUE_CONCURRENCY_ENV = 'OPENCODE_MULTI_AUTH_REFRESH_QUEUE_CONCURRENCY'
...
function resolveRefreshQueueConcurrency(targetCount: number): number {
  ...
  const raw = process.env[REFRESH_QUEUE_CONCURRENCY_ENV] || process.env[LEGACY_REFRESH_QUEUE_CONCURRENCY_ENV]
