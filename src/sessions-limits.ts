...
function buildWindow(limit: SessionRateLimit | undefined, eventTs?: number): RateLimitWindow | undefined {
	...
	const resetAt =
		...
		(typeof limit.resets_in_seconds === 'number' && eventTs ? eventTs + limit.resets_in_seconds * 1000 : undefined)
...
export function findLatestSessionRateLimits(options?: { sinceMs?: number; untilMs?: number; sessionsDir?: string }): {
