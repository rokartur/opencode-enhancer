import { flushStoreToDisk, getStoreDiagnostics, loadStore, saveStore, updateAccount } from './store.js'
...
export function markWorkspaceDeactivated(alias: string, cooldownMs: number, info?: { error?: string }): void {
	updateAccount(alias, {
