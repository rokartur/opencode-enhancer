...
const body = messageArgIndex >= 0 ? argv[messageArgIndex + 1] || 'OSC 9 terminal notification' : 'OSC 9 terminal notification'
...
if (!support.supported) {
  console.error('Refusing to send OSC 9 because this terminal is not currently detected as supported. Use --check for diagnostics only.')
  process.exit(1)
}
