...
export declare function getMinRemaining(rateLimits?: AccountRateLimits): number;
export declare function selectBestAvailableAccount(excludeAlias?: string, threshold?: number): string | null;
